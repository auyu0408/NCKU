...
#include "PinChangeInt.h" // This must be included in order to use pins other than 2 and 3 in UNO
...
//  digitalWrite(ARDUINOPIN, HIGH);     // See http://arduino.cc/en/Tutorial/DigitalPins
  attachPinChangeInterrupt(isObstaclePin, interruptFunction, FALLING);
  Serial.begin(115200);
  Serial.println("---------------------------------------");
}
